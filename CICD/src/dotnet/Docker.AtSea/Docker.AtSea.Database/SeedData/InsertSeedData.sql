...
INSERT INTO Products (Name, Description, Price, Image) 
 SELECT 'MD', 'MD DevOps', 666, BulkColumn FROM OPENROWSET(BULK 'C:\init\SeedData\images\md.png', SINGLE_BLOB) rs;
 INSERT INTO Products (Name, Description, Price, Image) 
 SELECT 'MD', 'MD DevOps', 101, BulkColumn FROM OPENROWSET(BULK 'C:\init\SeedData\images\CIA-MDDevOps.png', SINGLE_BLOB) rs;
INSERT INTO Products (Name, Description, Price, Image) 
